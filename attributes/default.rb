...
default['kibana']['version'] = '4.0.0-beta3' # must match version number of kibana being installed
...
default['kibana']['file']['url'] = 'https://download.elasticsearch.org/kibana/kibana/kibana-4.0.0-beta3.tar.gz'
